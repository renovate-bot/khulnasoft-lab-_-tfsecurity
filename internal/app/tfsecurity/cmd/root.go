...
func Root() *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short:             "tfsecurity is a terraform security scanner",
		Long:              `tfsecurity is a simple tool to detect potential security vulnerabilities in your terraformed infrastructure.`,
